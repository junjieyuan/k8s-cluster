...
Compile the Butane template (gpu-worker.bu.tmpl) into an Ignition config (gpu-worker.ign),
...
TEMPLATE="${SCRIPT_DIR}/gpu-worker.bu.tmpl"
OUTPUT="${SCRIPT_DIR}/gpu-worker.ign"
